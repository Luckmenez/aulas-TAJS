...
describe("E2E Test Suite", () => {
  describe("E2e Tests for Server in a non-test env", () => {
    it("should start server with PORT 4000", async () => {
      ...
      expect(serverInfo.port).toBe(7657);
  ...
  describe("E2E Tests for Server", () => {
    ...
    it("Should not be able to create a Person without username", async () => {
      const invalidPayload = { cpf: "425.425.425-45" }; // Missing CPF
    ...
    it("Should be able to create a Person", async () => {
      const validPayload = { name: "Fulano da Silva", cpf: "425.425.425-45" };
    ...
    it("Should Throw if Person tries to save a invalid person", async () => {
      const invalidPayload = { cpf: "425.425.425-45", name: "Fulano da Silva" };
